...
public class EnvironmentController {
	...
	private static final String API = "/cursomicros";
	...
	public ResponseEntity<Environments> listarEntornos() {

	    	Environments response = service.listarEntornos();
	        ...
	        return new ResponseEntity<Environments>(response, statusResponse);
	    }
